...
class SaloonDetailView extends StatefulWidget {
  SaloonDetailView({Key? key, required this.item}) : super(key: key);
  final Saloon item;
  final controller = Get.put(SaloonsController());

  @override
  State<SaloonDetailView> createState() => _SaloonDetailView();
}

class _SaloonDetailView extends State<SaloonDetailView> {
  // var employees;
  // var services;
  // Employee? employees;
                    ...
                    child: Row(
                      ...
                      children: [
                        ...
                        SizedBox(
                          ...
                          child: iconButton(
                              onClick: () async {
                                Get.to(AddUpdateSaloon(item: widget.item));
                              },
                              icon: const Icon(
                                Icons.edit,
                                size: 20,
                          ...
                          child: iconButton(
                              onClick: () async {
                                genericPopup(context,
                                    ...
                                    children: GetX<SaloonsController>(
                                        builder: (controller) {
                                  return Container(
                                                  ...
                                                  onClick: () async {
                                                    ...
                                                    if (respose) {
                                                      ToastMessages.showSuccess(
                                                          "Saloon has been ${widget.item.isBlocked == 0 ? "blocked" : "unblocked"}");
